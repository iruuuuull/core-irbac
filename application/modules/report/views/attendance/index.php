                ...
                <div class="table-toolbar">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <select id="id_karyawan" class="form-control itemName select2">
                                        <option value="">- Select Employee -</option>
                                    </select>
                                </div>                                 
                            </div>
                            <div class="col-md-1"> 
                                <button type="button" id="btn-cari-reportAtten" style="margin-top: 5px;" class="btn btn-sm green"><i class="fa fa-check"></i> Proses</button>
                            </div>
                        </div>
                    </div>
                </div>
