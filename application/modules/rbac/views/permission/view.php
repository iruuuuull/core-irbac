...
<h1 class="page-title"><?= ucwords(str_replace('-', ' ', $model->name)) ?></h1>
            ...
            <div class="card-body">
            	<div class="row">
		            <div class="col-sm-5">
		                <div class="input-group">
		                    ...
		                    <span class="input-group-btn">
		                        <?= $this->html->a('<span class="fa fa-sync"></span>', "/rbac/permission/refresh/{$model->id}", [
		            ...
		            <div class="col-sm-2 text-center">
		                <br><br>
		                <?= $this->html->a('&gt;&gt;' . $animateIcon, "/rbac/permission/assign/{$model->id}", [
		                    'class' => 'btn btn-success btn-assign ladda-button',
		                    'data-target' => 'available',
		                    'title' => 'Assign',
		                ]) ?><br><br>
		                <?= $this->html->a('&lt;&lt;' . $animateIcon, "/rbac/permission/remove/{$model->id}", [
